...
class HomeViewModel @ViewModelInject constructor(
    ...
    private val _showGenreMessageEvent = MutableLiveData<Event<String>>()
    val showGenreMessageEvent: LiveData<Event<String>> = _showGenreMessageEvent
    ...
    fun showGenreTitle(title: String) {
        _showGenreMessageEvent.value = Event(title)
    }
}
